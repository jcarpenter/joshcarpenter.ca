...
(function(window, document) {
  ...
  function fixImgHeight() {
    ...
    const lineHeight = parseInt(style.getPropertyValue('line-height')) / 2
    ...
    for (let i = 0; i < images.length; ++i) {
      ...
      const imgOriginalHeight = images[i].offsetHeight

      // Calculate new height
      const imgRatio = Math.floor(imgOriginalHeight / lineHeight)
      const imgNewHeight = lineHeight * imgRatio
